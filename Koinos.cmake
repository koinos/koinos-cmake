...
if(CCACHE_PROGRAM)
  ...
  set(CMAKE_XCODE_ATTRIBUTE_CC           "${CMAKE_PROJECT_DIR}/ci/ccache_clang")
  set(CMAKE_XCODE_ATTRIBUTE_CXX          "${CMAKE_PROJECT_DIR}/ci/ccache_clang++")
  set(CMAKE_XCODE_ATTRIBUTE_LD           "${CMAKE_PROJECT_DIR}/ci/ccache_clang")
  set(CMAKE_XCODE_ATTRIBUTE_LDPLUSPLUS   "${CMAKE_PROJECT_DIR}/ci/ccache_clang++")
endif()
